...
const deleteNews = async (req, res) => {
  ...
  try {
    ...
    const filePath = [`Blog_Images/${imageDir}`, `Blog_Video/${videoDir}`];
...
//                 const fileName = `${req.files?.BlogImage[0]?.filename}`;
...
//                 updates.ImageURL = `http://localhost:1008/admin/blogImage/${fileName}`;
//             }
